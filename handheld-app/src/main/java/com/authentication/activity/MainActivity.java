...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void initData() {
		...
		icons = new int[] { R.drawable.sfz, R.drawable.beidou, R.drawable.loop, R.drawable.fingerprint, R.drawable.m1,
				R.drawable.rfid15693, R.drawable.hx, R.drawable.ic, R.drawable.cpu, R.drawable.barcode, R.drawable.ic,
				R.drawable.ic, R.drawable.fingerprint, R.drawable.ic };
	...
	private void showActivity(String str) {
		...
		case 8:
			...
			break;
		case 9:
			startActivity(new Intent(this, SoftDecodingsActivity.class));
			break;
		case 10:
			startActivity(new Intent(this, PsamActivity.class));
			break;
		case 11:
